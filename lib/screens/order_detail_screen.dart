...
import 'package:tailoredtiffin/controllers/order_detail_controller.dart';
...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  var orderCtrl = Get.put(OrderDetailController());
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          Row(
                            ...
                            mainAxisAlignment: mainEnd,
                            children: [
                              Text(orderCtrl.orderData!.order!.payment_type.toString().toUpperCase(),
